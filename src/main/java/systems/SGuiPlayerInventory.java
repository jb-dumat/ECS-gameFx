 ...
 */
public class SGuiPlayerInventory {
    /**
    ...
    public static void update() {
        ...
        ecs.forEachIfContains((Entity e) -> {
            CInventory inventory = ecs.getComponent(e, CInventory.class);
            ObservableList<String> items = controller.playerInventory.getItems();
